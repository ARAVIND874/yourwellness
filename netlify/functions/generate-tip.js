...
exports.handler = async (event, context) => {
    ...
    try {
        ...
        const model = genAI.getGenerativeModel({ model: "gemini-pro-vision" }); // அல்லது "gemini-1.5-flash" போன்றவை

        console.log('Calling Gemini API with model:', "gemini-pro-vision");
